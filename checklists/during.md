...
| Change a device parameter on a track | `{"operation": "device.param_change", "attributes": {"track": "<name>", "param_index": 0, "value": 0.5}}` — auto-ALLOW only if `<name>` starts with `GEN-` |
